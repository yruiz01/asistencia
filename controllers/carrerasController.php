...
switch ($option) {
    ...
    case 'save':
        ...
        if ($id_carrera == '') {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'ÁREA REGISTRADA');
                } else {
                    $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL AGREGAR');
                }
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'EL ÁREA YA EXISTE');
            }
        } else {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'ÁREA MODIFICADA');
                } else {
    ...
    case 'delete':
        ...
        if ($data) {
            $res = array('tipo' => 'success', 'mensaje' => 'ÁREA ELIMINADA');
        } else {
