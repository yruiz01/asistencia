...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?php echo RUTA . 'assets/'; ?>images/logo.ico" />
</head>
<body>
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="plantilla.php"><img src="<?php echo RUTA . 'assets/'; ?>images/registro.gif" width="60" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="plantilla.php"><img src="<?php echo RUTA . 'assets/'; ?>images/registro.gif" width="30" alt="logo"/></a>
          </div>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                <img src="<?php echo RUTA . 'assets/'; ?>images/avatar.gif" alt="profile"/>
